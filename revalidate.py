...
def generate_traceability_report():
    with open("traceability_report.md", "w") as f:
        ...
        f.write("| Requirement ID | Verification Check |\n")
        f.write("|---|---|\n")
        for req, check in _requirements_tested:
            f.write(f"| {req} | {check} |\n")
...
def revalidate(max_latency=DEFAULT_MAX_LATENCY):
    ...
    for name, func, args in checks:
        ...
        if hasattr(func, "req_id") and passed:
            _requirements_tested.append((func.req_id, name))
